    ...
    return (
        <div className="section-contact-us p-8 bg-gradient-to-r from-indigo-300 to-purple-400 rounded-lg shadow-xl">
            <div className="flex flex-col lg:flex-row">
                {/* Message Section */}
                <div className="section-contact-us m-4 p-8 bg-gradient-to-r from-indigo-300 to-purple-400 rounded-lg shadow-xl">
                    <div className="flex flex-col lg:flex-row">
                        {/* Message Section with Glassmorphic Effect */}
                        <div className="flex-1 m-4 p-6 bg-white/30 backdrop-blur-md rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-103">
                ...
                <div className="flex-1 p-8 flex justify-center">
                    <div className="w-full h-[800px] md:h-[800px] p-5 lg:h-[800px]  rounded-lg shadow-xl border border-gray-300 backdrop-blur-lg bg-white/30">
                        <iframe
